...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """users""", """controllers.UserController.getAllUser()"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """user/addUser""", """controllers.UserController.addUser()"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """users/addUser""", """controllers.UserController.save()"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_UserController_getAllUser1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users")))
  )
  private[this] lazy val controllers_UserController_getAllUser1_invoker = createInvoker(
    UserController_2.getAllUser(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  private[this] lazy val controllers_UserController_save3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/addUser")))
  )
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_UserController_getAllUser1_route(params@_) =>
      call { 
        controllers_UserController_getAllUser1_invoker.call(UserController_2.getAllUser())
      }
  
    // @LINE:9
    case controllers_UserController_addUser2_route(params@_) =>
      call { 
        controllers_UserController_addUser2_invoker.call(UserController_2.addUser())
      }
  
    // @LINE:10
    case controllers_UserController_save3_route(params@_) =>
      call { 
        controllers_UserController_save3_invoker.call(UserController_2.save())
      }
